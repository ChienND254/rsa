...
//        jProgressBar1 = new JProgressBar();
    ...
    private void initComponents() {
        ...
        jButton7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/digittal/signature/rsa/disk_black.png")));
        ...
        jTextArea4.setFont(new java.awt.Font("Times New Roman", 0, 13));
        ...
        jButton8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/digittal/signature/rsa/disk_black.png")));
        ...
        jTextArea5.setFont(new java.awt.Font("Times New Roman", 0, 13));
        ...
        jTextArea6.setFont(new java.awt.Font("Times New Roman", 0, 13));
        ...
        jLabel15.setFont(new java.awt.Font("Copperplate Gothic Light", 1, 24));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        rsa.KeyRSA(bitleg);
        jLabel16.setText("Đã tạo khóa bí mật");
        jLabel16.setForeground(Color.red);
        jLabel17.setText("Đã tạo khóa công khai");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if ("".equals(filename)) {
            jProgressBar1.setIndeterminate(true);
            JOptionPane.showMessageDialog(null, "Chưa nhập dữ liệu đầu vào","Thông báo", JOptionPane.ERROR_MESSAGE);
            ...
            try {
                ...
                jProgressBar1.setValue(200);
                jProgressBar1.setIndeterminate(false);
                JOptionPane.showMessageDialog(null, "Tạo chữ ký khóa thành công!", "Thông báo", JOptionPane.ERROR_MESSAGE);
        ...
        if ("".equals(filename)) {
            ...
            try {
                ...
                if (jTextArea5.getText().equals(jTextArea6.getText())) {
                    JOptionPane.showMessageDialog(null, "Chữ ký số không thay dổi", "Thông báo", JOptionPane.INFORMATION_MESSAGE);
                } else {
                    JOptionPane.showMessageDialog(null, "Chữ ký số thay đổi!!!", "Thông báo", JOptionPane.ERROR_MESSAGE);
                }
